...
from trader.event import FillEvent, OrderEvent
from trader.performance import create_sharpe_ratio, create_drawdowns
...
class Portfolio(object):
    ...
    def update_positions_from_fill(self,fill):
        ...
        """
        #check whethere the fill is buy or sell
        fill_dir = 0
    ...
    def output_summary_stats(self):
        ...
        sharpe_ratio = create_sharpe_ratio(returns, period=252)
